...
const products: ProductType[] = [
    {
        id: 1,
        section: "Company",
        link: ['Sobre Nosotros', 'Careers', 'Mobile', 'Blog', '¿Como trabajamos?'],
    },
    {
        id: 2,
        section: "Contact",
    ...
    return (
        ...
        <div className="mx-auto max-w-2xl pt-24 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
            <div className="my-12 grid grid-cols-1 gap-y-10 sm:grid-cols-6 lg:grid-cols-12">
                ...
                <div className='sm:col-span-6 lg:col-span-5'>
                    <div className="flex flex-shrink-0 items-center border-right">
                        <Image src="/images/Logo/lejuy.svg" alt="logo" width={56} height={56} />
                        <Link href="/" className='text-2xl font-semibold text-black ml-4'>
                            Lejuy.
                        </Link>
                    </div>
                    <h3 className='text-textbl text-xs font-medium mt-5 mb-4 lg:mb-16'> Seguinos es todas nuestras <br /> redes sociales.</h3>
            ...
            <div className='py-10 md:flex items-center justify-between border-t border-t-bordertop'>
                <h4 className='text-darkgrey text-sm text-center md:text-start font-normal'>@2024 - Lejuy. Todos los derechos reservados <Link href="https://adminmart.com/" target="_blank"> Adminmart.com</Link></h4>
